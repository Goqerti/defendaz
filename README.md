# Defend The Castle (JSON DB build)

✅ This fork/build replaces PostgreSQL with a simple file-based JSON database.
- Default DB folder: `./db/`
- Override with env: `JSON_DB_DIR=/path/to/db`
